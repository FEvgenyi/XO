...
namespace X_O {
    public partial class Form1 : Form {
        ...
        private void b2_Click(object sender, EventArgs e) {
            b2.Text = XorO;
            if (XorO == "X") { message = "2X"; b2.BackColor = Color.Red; } 
            else if (XorO == "O") {message = "2O"; b2.BackColor = Color.Green; }
            b_OFF();
            Client();
            WINNERCheck();
        }
        private void b3_Click(object sender, EventArgs e) {
            b3.Text = XorO;
            if (XorO == "X") { message = "3X"; b3.BackColor = Color.Red; } 
            else if (XorO == "O") { message = "3O"; b3.BackColor = Color.Green; }
            b_OFF();
            Client();
            WINNERCheck();
        }
        private void b4_Click(object sender, EventArgs e) {
            b4.Text = XorO;
            if (XorO == "X") { message = "4X"; b4.BackColor = Color.Red; } 
            else if (XorO == "O") { message = "4O"; b4.BackColor = Color.Green; }
            b_OFF();
            Client();
            WINNERCheck();
        }
        private void b5_Click(object sender, EventArgs e) {
            b5.Text = XorO;
            if (XorO == "X") { message = "5X"; b5.BackColor = Color.Red; } 
            else if (XorO == "O") { message = "5O"; b5.BackColor = Color.Green; }
            b_OFF();
            Client();
            WINNERCheck();
        }
        private void b6_Click(object sender, EventArgs e) {
            b6.Text = XorO;
            if (XorO == "X") { message = "6X"; b6.BackColor = Color.Red; } 
            else if (XorO == "O") { message = "6O"; b6.BackColor = Color.Green; }
            b_OFF();
            Client();
            WINNERCheck();
        }
        private void b7_Click(object sender, EventArgs e) {
            b7.Text = XorO;
            if (XorO == "X") { message = "7X"; b7.BackColor = Color.Red; } 
            else if (XorO == "O") { message = "7O"; b7.BackColor = Color.Green; }
            b_OFF();
            Client();
            WINNERCheck();
        }
        private void b8_Click(object sender, EventArgs e) {
            b8.Text = XorO;
            if (XorO == "X") { message = "8X"; b8.BackColor = Color.Red; } 
            else if (XorO == "O") { message = "8O"; b8.BackColor = Color.Green; }
            b_OFF();
            Client();
            WINNERCheck();
        }
        private void b9_Click(object sender, EventArgs e) {
            b9.Text = XorO;
            if (XorO == "X") { message = "9X"; b9.BackColor = Color.Red; } 
            else if (XorO == "O") { message = "9O"; b9.BackColor = Color.Green; }
            b_OFF();
            Client();
            WINNERCheck();
        } 
        ...
        private void b_ADRESS_Click(object sender, EventArgs e) {
